...
import deep.pcd.config.Configuration;
...
public final class Runtime {
    ...
    public static void showRuntimeStats() {
        ...
        System.out.println("   # finishes = " + BaseTask.FinishTask.TASK_COUNTER.get());
        System.out.println("   # async = " + BaseTask.FutureTask.TASK_COUNTER.get());
    }
}

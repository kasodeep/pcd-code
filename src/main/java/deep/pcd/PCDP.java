...
import deep.pcd.config.SystemProperty;
import deep.pcd.runtime.BaseTask.*;
import deep.pcd.runtime.BaseTask;
import deep.pcd.runtime.IsolatedManager;
import deep.pcd.runtime.Runtime;
...
public final class PCDP {
    ...
    static final String missingFinishMsg = "A new task cannot be " +
     ...
     *                 parallel loop.
     */
    public static void forall(final int startInc, final int endInc, final ProcedureInt1D body) {
        finish(() -> forasync(startInc, endInc, body));
    }
     ...
     *                  nested loops.
     */
    public static void forall2d(final int startInc0, final int endInc0, final int startInc1, final int endInc1, final ProcedureInt2D body) {
        finish(() -> forasync2d(startInc0, endInc0, startInc1, endInc1, body));
    }
    ...
    public static void forasyncChunked(final int start, final int endInclusive, final ProcedureInt1D body) {
        forasyncChunked(
                start,
                endInclusive,
                getChunkSize(endInclusive - start + 1, numThreads() * 2),
                body);
    }
     ...
     * @param body          The body of the loop to execute
     */
    public static void forasync2dChunked(final int start0, final int endInclusive0, final int start1, final int endInclusive1,
    ...
    public static void forasync2dChunked(final int start0, final int endInclusive0, final int start1, final int endInclusive1,
        ...
        final int numIters = (endInclusive0 - start0 + 1) * (endInclusive1 - start1 + 1);
    ...
    public static void forallChunked(final int start, final int endInclusive, final int chunkSize, final ProcedureInt1D body) {
        finish(() -> forasyncChunked(start, endInclusive, chunkSize, body));
    }
     ...
     * @param body          The body of the loop to execute
     */
    public static void forall2dChunked(final int start0, final int endInclusive0, final int start1, final int endInclusive1,
                                       final int chunkSize, final ProcedureInt2D body) {
        finish(() -> forasync2dChunked(start0, endInclusive0, start1, endInclusive1,
                chunkSize, body));
    }
     ...
     */
    public static void asyncAwait(final Runnable runnable, final Future<?>... futures) {
        final FutureTask<Void> newTask = createFutureTask(runnable);
        CompletableFuture
     ...
     * created task and fetch its return value.
     */
    public static <R> Future<R> futureAwait(final Callable<R> runnable, final Future<?>... futures) {
     ...
     * @return A FutureTask object to execute on the runtime.
     */
    private static <R> FutureTask<R> createFutureTask(final Callable<R> body, final boolean rethrowException) {
        final BaseTask currentTask = Runtime.currentTask();
        if (currentTask == null) {
            throw new IllegalStateException(missingFinishMsg);
        }
     ...
     *                     nested loops.
     */
    public static void forseq(final int start, final int endInclusive, final ProcedureInt1D body) {
        assert (start <= endInclusive);
     ...
     *                      nested loops.
     */
    public static void forseq2d(final int start0, final int endInclusive0, final int start1, final int endInclusive1,
                                final ProcedureInt2D body) {
        assert (start0 <= endInclusive0);
        assert (start1 <= endInclusive1);
     ...
     * @param runnable The body to be executed in isolation.
     */
    public static void isolated(final Object obj1, final Object obj2, final Runnable runnable) {

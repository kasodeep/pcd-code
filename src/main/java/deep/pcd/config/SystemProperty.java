...
public enum SystemProperty {
     ...
     */
    numWorkers("pcdp.numWorkers", "int", "Number of worker threads to create", Constants.AVAILABLE_PROCESSORS_STR),
    /**
     ...
     */
    public static void setSystemProperty(final SystemProperty hjSystemProperty, final Object value) {
    ...
    private static class Constants {
         ...
         */
        private static final String AVAILABLE_PROCESSORS_STR = Integer.toString(availableProcessors);
        /**
